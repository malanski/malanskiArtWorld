...
const ItemDescription =
  'Chose artwork print location on front or back. Chose colors(black, denim, royal, navy, dark blue, heather charcoal). Slim fit, so size up if you prefer a regular fit, or go two sizes up for a baggy fit. Midweight 7.5 oz (250gsm) French terry, ring-spun for softness. Solid colors are 80% ring-spun cotton, 20% polyester. Heather colors are 60% ring-spun cotton, 40% polyester. Cold wash and hang out to dry to preserve your print. 1 x 1 rib cuffs with spandex to maintain shape. Front pouch (kangaroo) pocket and dyed to match drawcord detailing. Custom printed with your chosen artwork, when you order. The third party printer of this product is evaluated according to International Labor Organization standards. The printer of this product sources blanks from manufacturers committed to improving cotton farming practices with the Better Cotton Initiative'
